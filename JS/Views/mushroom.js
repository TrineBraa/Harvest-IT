...
function chanterelleInfoView(){
    ...
    den vokser i hele landet og har lang sesong. det vitenskapelige navnetfor kantarell er <italic>Chantarellus Cibarius</italic>.</p>
    <h3>Beskrivelse</h3>
...
function pennyBunInfoView(){
    ...
    men er vangligst fra Juli til September. den danner sopprot med ulike skogstær.
     Det vitenskapelige navnet for Steinsopp er <italic>Boletus Edulis</italic>.</p>
    <h3>Beskrivelse</h3>
...
function AgaricusInfoView(){
    ...
    Det vitenskapelige navnet er <italic>Agaricus</italic>.</p>
    <h3>Beskrivelse</h3>
